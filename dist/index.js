...
var form_data_1 = __importDefault(__nccwpck_require__(5161));
/**
...
var populate = __nccwpck_require__(7817);
...
var _a, _b;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.initWebstatsGraphqlClient = void 0;
__nccwpck_require__(4227);
var graphql_request_1 = __nccwpck_require__(2476);
var apiKey = (_a = process.env) === null || _a === void 0 ? void 0 : _a.WEBSTATS_API_KEY;
if (!apiKey) {
    throw new Error('Environment variable WEBSTATS_API_KEY not set');
}
var BASE_URL = (_b = process.env.WEBSTATS_BASE_URL) !== null && _b !== void 0 ? _b : 'https://webstats.vercel.app/api/graphql';
var initWebstatsGraphqlClient = function () {
    var client = new graphql_request_1.GraphQLClient(BASE_URL, {
        headers: {
            "x-api-key": apiKey
        }
    });
...
exports.initWebstatsGraphqlClient = initWebstatsGraphqlClient;
...
var StatisticTypes;
(function (StatisticTypes) {
    StatisticTypes["Generic"] = "GENERIC";
    StatisticTypes["Lighthouse"] = "LIGHTHOUSE";
    StatisticTypes["GoogleAnalytics"] = "GOOGLE_ANALYTICS";
    StatisticTypes["Netlify"] = "NETLIFY";
    StatisticTypes["Axe"] = "AXE";
    StatisticTypes["Webhint"] = "WEBHINT";
...
exports.CreateNetlifyStatisticDocument = graphql_tag_1.default(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    mutation createNetlifyStatistic($projectId: String!, $gitCommitSha: String, $branch: String, $data: JSONObject!) {\n  createNetlifyStatistic(\n    projectId: $projectId\n    gitCommitSha: $gitCommitSha\n    branch: $branch\n    data: $data\n  ) {\n    id\n  }\n}\n    "], ["\n    mutation createNetlifyStatistic($projectId: String!, $gitCommitSha: String, $branch: String, $data: JSONObject!) {\n  createNetlifyStatistic(\n    projectId: $projectId\n    gitCommitSha: $gitCommitSha\n    branch: $branch\n    data: $data\n  ) {\n    id\n  }\n}\n    "])));
...
function getSdk(client, withWrapper) {
    ...
    return {
        createNetlifyStatistic: function (variables, requestHeaders) {
            return withWrapper(function () { return client.request(graphql_1.print(exports.CreateNetlifyStatisticDocument), variables, requestHeaders); });
        }
    };
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__nccwpck_require__(4227);
var webstats_reporters_utils_1 = __nccwpck_require__(4759);
var graphql_1 = __nccwpck_require__(9193);
var node_fetch_1 = __nccwpck_require__(467);
var projectId = (_a = process.env) === null || _a === void 0 ? void 0 : _a.WEBSTATS_PROJECT_ID;
if (!projectId) {
    throw new Error('Environment variable WEBSTATS_PROJECT_ID not set');
}
var netlifyId = (_b = process.env) === null || _b === void 0 ? void 0 : _b.NETLIFY_ID;
if (!netlifyId) {
    throw new Error('Environment variable NETLIFY_ID not set');
}
var netlifyAuthToken = (_c = process.env) === null || _c === void 0 ? void 0 : _c.NETLIFY_AUTH_TOKEN;
if (!netlifyAuthToken) {
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getNetlifyData()];
                case 1:
                    data = _a.sent();
...
function generateUrl(id, service, range, resolution, limit) {
    var timeRange = "from=" + range.from + "&to=" + range.to;
    if (resolution === 'range') {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, node_fetch_1.default(generateUrl(netlifyId, 'pages', range, 'day', 9999), {
                            headers: headers,
                        })];
                case 1:
                    data = _a.sent();
...
function transformData(data) {
    return {
        version: '1',
        pages: data.data.map(function (page) {
            return {
...
function createNetlifyStatistic(data) {
    return __awaiter(this, void 0, void 0, function () {
        var e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, webstatsSdk.createNetlifyStatistic({
                            projectId: projectId,
                            data: data,
                        })];
                case 1:
